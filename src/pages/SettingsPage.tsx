      ...
      <div className="pt-2">
        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/70">
          <div className="border-b border-zinc-800 p-4">
            <div className="text-xs uppercase tracking-wide text-zinc-500">Workout</div>
          </div>

          <div className="border-b border-zinc-800 p-4">
            <label className="block">
              <span className="text-sm font-medium">Default Rest Timer</span>
              <select
                value={settings.defaultRestTimer}
                onChange={e => update({ defaultRestTimer: Number(e.target.value) })}
          ...
          <label className="flex items-center justify-between gap-4 p-4">
            <div>
              <div className="text-sm font-medium">Auto Start Rest Timer</div>
            ...
            <input
              ...
              onChange={e => update({ autoStartRestTimer: e.target.checked })}
        ...
        <div className="mt-8 border-t border-zinc-800 pt-6 text-center">
          <div className="text-sm font-semibold">Workout Tracker</div>
          <div className="mt-1 text-xs text-zinc-500">Built by Ankit Sharma</div>
          <div className="mt-1 text-xs text-zinc-600">Version 2.0.0</div>
        </div>
      </div>
    </Page>
  );
